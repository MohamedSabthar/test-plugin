                ...
                if (needBuildWithTest) {
                    ...
                    project.exec {
                        ...
                        if (checkForBreakingChanges) {
                            ...
                            commandLine 'sh', '-c', "docker run --rm --net=host --user \$(id -u):\$(id -g) -v $project.projectDir/..:/home -v $project.projectDir:/home/ballerina ballerina/ballerina:nightly tree -d ."
